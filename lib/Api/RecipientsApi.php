...
class RecipientsApi
{
    ...
    /**
     * Operation resendInvitationsForShare
     *
    ...
    /**
     * Operation resendInvitationsForShareWithHttpInfo
     *
     * Resend invitations to share recipients
     *
     * @param  string $evApiKey API Key required to make the API call. (required)
    ...
    /**
     * Operation resendInvitationsForShareAsync
     *
     * Resend invitations to share recipients
     *
     * @param  string $evApiKey API Key required to make the API call. (required)
    ...
    /**
     * Operation resendInvitationsForShareAsyncWithHttpInfo
     *
     * Resend invitations to share recipients
     *
     * @param  string $evApiKey API Key required to make the API call. (required)
    ...
    protected function resendInvitationsForShareRequest($evApiKey, $evAccessToken, $shareId, $body = null)
    {
        ...
        $resourcePath = '/recipients/shares/invites/{shareId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
